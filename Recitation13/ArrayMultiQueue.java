 ...
 */
public final class ArrayMultiQueue<T>  extends AbstractCollection<T> implements MultiQueue<T> {
     ...
     * @return IllegalStateExcepton if full
     */
    @Override
    ...
    public boolean offer(T m, int priority) {
    	return queue[priority].offer(m);
    }

    /**
     * Removes front element entered in the queue.
     * 
     * @return front message of queue 
     ...
     *
     * @return front message of the queue 
     * @throws NoSuchElementException if empty
     */
    @Override
    public T get() {
     ...
     * @return nth element of the queue
     */
    public T get(int n) {
