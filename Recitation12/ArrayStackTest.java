...
public class ArrayStackTest {
	...
	public void testStack() {
        ...
        ArrayStack<Character> stack2 = new ArrayStack<>(stack);
        ...
        // Peek at items in stack and check the character values
        assertEquals("peek 0", val[5], stack.peek(0));
        assertEquals("peek 5", val[0], stack.peek(5));
        assertEquals("peek -1", val[0], stack.peek(-1));
        assertEquals("peek -6", val[5], stack.peek(-6));
