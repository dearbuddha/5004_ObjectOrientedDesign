...
final public class ArrayDeque {
    ...
    public ArrayDeque(ArrayDeque other) {
    	dequeArr = other.dequeArr.clone();  //clone is shallow copy by default
    	front = other.front;
    	rear = other.rear;
    ...
    public Object removeFirst() {
        ...
        Object frontElement = dequeArr[front];
        
        // erase Object so we know it is gone
        dequeArr[front] = null;
   ...
   public Object removeLast() {
       ...
       // get front element to return
       Object rearElement = dequeArr[rear];
   ...
   Object peek(int n) {
       if (n < -size() || n >= size()) {
    	   return null;  // indicates no Object
       }
    ...
    */
    ...
    private void resize() {
        ...
        Object[] resizedArr = new Object[2 * capacity()];
    ...
    public boolean equals(Object o) {
    	...
    	for (int i = 0; i < size(); i++) {
    		Object this_o = peek(i);  // element of this instance
    		Object other_o = other.peek(i);  // element of other instance
