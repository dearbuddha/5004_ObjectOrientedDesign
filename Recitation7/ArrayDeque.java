 ...
 */
final public class ArrayDeque<E> {
    ...
    public ArrayDeque(int capacity) {
        ...
        dequeArr = (E[]) new Object[capacity];
    }
    ...
    public void addLast(E c) {
        if(c == null){
            throw new IllegalArgumentException("Adding a null value is not allowed.");
        }
    ...
    *   does not exist
    */
   public E peek(int n) {  // think about the visibility of this method
       if (n < -size() || n >= size()) {
    	   return null;  // indicates no char
       }
    ...
    */
    ...
    private void resize() {
        ...
        E[] resizedArr = (E[]) new Object[2 * capacity()];
