...
public class ArrayDequeTest {
    ...
    public void testDeque() {
        ...
        assertEquals("peekFirst", null, deque.peekFirst());
        
        // queue has no last element
        assertEquals("peekLast", null, deque.peekLast());
        ...
        assertEquals("Remove first item", null, deque.removeFirst());
        assertEquals("Remove last item",  null, deque.removeLast());
    }   
}
